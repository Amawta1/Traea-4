...
public class Empresa {
    ...
    public Empresa(String productoCreado, String creadorEmpresa, String nombreEmpresa, 
            int yearCreado, Empleado nombreEmpleado, int numCodigo) {
    ...
    public String toString() {
        return "Empresa{" + "Producto Creado=" + productoCreado +
                ", Creador de la Empresa=" + creadorEmpresa + ", Nombre de la Empresa=" 
                + nombreEmpresa + ", Year Creado=" + yearCreado + ", Nombre del Empleado=" 
                + nombreEmpleado.getNombre() + " num Codigo=" + numCodigo+ '}';
    }
