...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        var empleado1 = new Empleado("Andres",LocalDate.of(2002, 8, 12),"0302592704",180,1,160);
        var empresa1 = new Empresa("Bebidas Gaseosas","Jhon Wilson","Coca Cola",1888,empleado1,1);
